...
//			option.series[1].data=json.messConsume;
			...
			option.title.text=json.year+"年大学生月平均生活费";			
	...
	function monthAverageList(option){
		...
		var option3={		   
		    ...
		    tooltip:{
		    	...
		    	formatter: function (point) {
		            return '消费总金额:'+point.data.sum+ '元<br>'
		                   +'平均金额:'+point.data.ang+ '元<br>';
		        }
		    },	   
		    series: [		        
		        {
		            ...
		            data:[
		                {value:0, name:'高消费学生',sum:0,ang:0},
		                {value:0, name:'中档消费学生',sum:0,ang:0},
		                {value:0, name:'低消费学生',sum:0,ang:0},
		            ]
		        }
		    ],		  		    			   
		    title: {			        
		...
		function SpendingPower(option)
		{
			...
			if(option.consumeLevelList)
			{
				...
				{					
					...
					heightpie.sum=option.consumeLevelList[0].totalMoney;					
					midepie.sum=option.consumeLevelList[1].totalMoney;					
					lowpie.sum=option.consumeLevelList[2].totalMoney;
					
					heightpie.ang=option.consumeLevelList[0].avgMoney;					
					midepie.ang=option.consumeLevelList[1].avgMoney;					
					lowpie.ang=option.consumeLevelList[2].avgMoney;			
		...
		var json3=SpendingPower(result);							
			if(json3==null)
			{
				...
				option3.series[0].data[0].name='高消费学生占比:'+json3.heightpie.value+"%";
				option3.series[0].data[0].sum=json3.heightpie.sum;
				option3.series[0].data[0].ang=json3.heightpie.ang;
				option3.series[0].data[1].value=json3.midepie.value;		
				option3.series[0].data[1].name='中档消费学生占比:'+json3.midepie.value+"%";
				option3.series[0].data[1].sum=json3.midepie.sum;
				option3.series[0].data[1].ang=json3.midepie.ang;
				option3.series[0].data[2].value=json3.lowpie.value;			
				option3.series[0].data[2].name='低消费学生占比:'+json3.lowpie.value+"%";
				option3.series[0].data[2].sum=json3.lowpie.sum;
				option3.series[0].data[2].ang=json3.lowpie.ang;

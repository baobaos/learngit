		...
		return this.each(function() {
			...
			this.createHtml = function() {
				...
				if (para.dragDrop) {
					...
					html += '				<div class="convent_choice" style="width: 45%;height: 130px;">';
					html += '					<div class="andArea">';
					html += '						<div class="filePicker">点击选择文件</div>';
					html += '						<input id="fileImage" type="file" size="30" name="fileselect[]" ' + multiple + ">";
					html += "					</div>";
					html += "				</div>";
					html += '				<span class="upload_drag_area" style="text-align: left;padding: 2em 10px 2em 30px;width: 45%;color: #ff0000;line-height: 27px;">特别提醒：<br>1.请将图片上传压缩后再上传。<br>2.<a href="https://tinypng.com/">图片压缩软件</a>(点击此处下载)<br>3.<a href="http://up.upweixin.com/resources/images/图片压缩使用文档.doc">图片压缩使用文档</a>(点击此处下载)</span>';
					html += "			</div>";
					html += '			<div class="status_bar"><div class="clear"></div>';
